# 0.2 JavaScript essentials

Review the must-know ES6 syntax and patterns before touching React.

## Key ideas
1. Connect the topic to the big picture of **Section 0 – Fundamentals**
